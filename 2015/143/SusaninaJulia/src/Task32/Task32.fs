...
let charting =
    Chart.Combine
        [
             Chart.Line( [ for i in 1..30 -> (i, time(fun () -> task8FibN (fromInt i) |> ignore) ) ], "Recursion", Color = System.Drawing.Color.Green)
             Chart.Line( [ for i in 1..10..1000 -> (i, time(fun () -> task9FibN (fromInt i) |> ignore) ) ], "Iteration", Color = System.Drawing.Color.Crimson)
             Chart.Line( [ for i in 1..10..1000 -> (i, time(fun () -> task10FibN (fromInt i) |> ignore) ) ], "Iteration without mutable", Color = System.Drawing.Color.DarkGoldenrod)
             Chart.Line( [ for i in 1..10..1000 -> (i, time(fun () -> task11FibN (fromInt i) |> ignore) ) ], "Matrix", Color = System.Drawing.Color.HotPink)
             Chart.Line( [ for i in 1..10..1000 -> (i, time(fun () -> task12FibN (fromInt i) |> ignore) ) ], "Matrix : log", Color = System.Drawing.Color.Maroon)
             Chart.Line( [ for i in 1..10..1000 -> (i, time(fun () -> task13FibN (fromInt i) |> ignore) ) ], "Fib in array", Color = System.Drawing.Color.MediumTurquoise)
        ]
